...
/* RGB : add a feedback version of this function */
...
runner_iact_nonsym_stars_feedback(float r2, const float *dx, float hi, float hj,
  ...
  /* RGB update the gas particle properties bhased on the mass, energy etc that the star wants to give away */

  ..find the EAGLE codeand put it here ..
