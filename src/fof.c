...
void fof_search_tree(struct space *s) {
  ...
  message("selfs took %18.3f", clocks_from_ticks(self_timer));
  message("pairs took %18.3f", clocks_from_ticks(pair_timer));
  self_timer = 0;
  pair_timer = 0;
